...
void mt_dynamic(int* cell_type, float3* r, int* mt_pol_conc, int* mt_depol_conc, int* mt_det_conc, int* mt_att_conc, int* type, int* connect_1, int* connect_2, float* len1, float* len2, float3* center, int* kinesin_att_conc, int* kinesin_det_conc, float* h_att_l);
