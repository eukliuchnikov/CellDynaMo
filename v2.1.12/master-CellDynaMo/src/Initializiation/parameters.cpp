...
void parameters(Config& config){
	...
	h_parameters->pole_dist = config.pole_distance;
	h_parameters->mt_n = config.mt_num;
	h_parameters->max_mt_n = config.max_mt_length;
	...
	h_parameters->a = config.ellipse_a;
	h_parameters->b = config.ellipse_b;
	h_parameters->c = config.ellipse_c;

	printf("%d\t%d\t%d\t%d\t%f\n", h_parameters->mt_n, h_parameters->max_mt_n, h_parameters->pole_n, h_parameters->kin_n,h_parameters->chrom_num);
