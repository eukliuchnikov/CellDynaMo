	...
	for (i = 1; i < num_x_cell + 1; i++){
		for (j = 1; j < num_y_cell + 1; j++){
			for (k = 1; k < num_z_cell + 1; k++){
				...
				/*hi[35] = Naa[l]*Nn0[l];					//phos1
				hi[36] = Naa[l]*Nn1[l];					//phos2
				hi[37] = Naa[l]*Nn2[l];					//phos3
				hi[38] = Naa[l]*Nn3[l];					//phos4
				hi[39] = Naa[l]*Nn4[l];					//phos5
				hi[40] = Naa[l]*Nn5[l];					//phos6
				hi[41] = Naa[l]*Nn6[l];					//phos7*/
