...
void MechanicalINIT(){
	...
	/*reactnum[35] = reactnum[0];
	reactnum[36] = reactnum[0];
	reactnum[37] = reactnum[0];
	reactnum[38] = reactnum[0];
	reactnum[39] = reactnum[0];
	reactnum[40] = reactnum[0];
	reactnum[41] = reactnum[0];*/
